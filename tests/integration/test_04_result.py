...
@pytest.fixture
def user_result_factory(odm_task_result_factory, user_result_workspace, image_file_factory):
    """Factory for results with actual file in user_999's workspace."""
    def factory(**kwargs):
        file_obj = image_file_factory()
        data = { 
            "workspace": user_result_workspace,
            "file": file_obj,
            **kwargs
        }
...
def internal_result_list_queries(result_list_factory):
    ...
    return [
        ...
        {"params": {"result_type": ODMTaskResultType.ORTHOPHOTO_GEOTIFF}, "expected_count": 3},
        {"params": {"result_type": ODMTaskResultType.POINT_CLOUD_PLY}, "expected_count": 2},
        ...
        {"params": {"result_type": ODMTaskResultType.ORTHOPHOTO_GEOTIFF, "created_after": after}, "expected_count": 2},
        {"params": {"result_type": ODMTaskResultType.POINT_CLOUD_PLY, "created_before": before}, "expected_count": 1},
        ...
        {"params": {"workspace_uuid": ws1_uuid, "result_type": ODMTaskResultType.POINT_CLOUD_PLY}, "expected_count": 2},
    ]
...
def public_result_list_queries(result_list_factory):
    ...
    return [
        ...
        {"params": {"result_type": ODMTaskResultType.ORTHOPHOTO_GEOTIFF}, "expected_count": 2},
        {"params": {"result_type": ODMTaskResultType.POINT_CLOUD_PLY}, "expected_count": 2},
        ...
        {"params": {"result_type": ODMTaskResultType.ORTHOPHOTO_GEOTIFF, "created_after": after}, "expected_count": 1},
        {"params": {"result_type": ODMTaskResultType.POINT_CLOUD_PLY, "created_before": before}, "expected_count": 1},

    ...
    def resolve_http_kwargs(self, scenario, config=None) -> dict:
        ...
        if payload_source is not None:
            if callable(payload_source):
                ...
                kwargs["json"] = self.r.resolve_ref(payload_source, (dict, list), "payload")
...
class CRUDRunner(BaseRunner[CRUDScenario, CRUDConfig]):
    ...
    def run(self, scenario: CRUDScenario, index: int, config: CRUDConfig | None = None) -> None:
    ...
    def _finalize_assertion(self, s: CRUDScenario, sid: str, obj: Any, comparison_data: Any) -> None:
        if s.assertion:
    ...
    def _do_create(self, s: CRUDScenario, i: int, config: CRUDConfig | None = None) -> None:
    ...
    def _do_get(self, s: CRUDScenario, i: int, config: CRUDConfig | None = None) -> None:
    ...
    def _do_update(self, s: CRUDScenario, i: int, config: CRUDConfig | None = None) -> None:
    ...
    def _do_delete(self, s: CRUDScenario, i: int, config: CRUDConfig | None = None) -> None:
...
class ActionRunner(BaseRunner[ActionScenario, ActionConfig]):
    ...
    def run(self, scenario: ActionScenario, index: int, config: ActionConfig | None = None) -> None:
        if not config:
...
class ListRunner(BaseRunner[ListScenario, ListConfig]):
    ...
    def run(self, scenario: ListScenario, index: int, config: ListConfig | None = None) -> None:
        if not config:

...
class TusSettingsMixin(BaseSettingsMixin):
    TUS_FILE_NAME_FORMAT: TusFileSecurityPolicy = Field(
        default=TusFileSecurityPolicy.RANDOM_SUFFIX
    )
    TUS_EXISTING_FILE: TusReplacementPolicy = Field(
        default=TusReplacementPolicy.OVERWRITE
    )
